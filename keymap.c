 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Ctl+Sh|AltTab| LGui | Undo | Redo |                                       | Left | Down |  Up  |Right | ->L1 |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Alt  | Esc  |       | Home | End   |
 *                                 ,------|------|------|       |------+-------+------.
...
[WORK] = KEYMAP(  // layer 0 : Colemak
        ...
        KC_LSFT,        KC_Z,       KC_X,    KC_M,   KC_C,   KC_V,   	KC_UNDS,
		    M(3),			      M(1),       KC_LGUI, LCTL(KC_Z),LCTL(KC_Y),
														                              KC_LALT,  KC_ESC,
																                                    LCTL(KC_C),
 ...
 * |        |      |      |      |      |      |      |           |      | Mute | Prev |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | Lclk | Rclk |                                       | Next |VolDn |VolUp | Play |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2,
                                  ...
                                  KC_TRNS, KC_TRNS, KC_TRNS,
    // right hand
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, AG_NORM, AG_SWAP,
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS,  KC_MUTE, KC_MPRV, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
